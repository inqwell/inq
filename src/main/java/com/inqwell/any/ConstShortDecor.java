...
/*
 * $Archive: /src/com/inqwell/any/ConstShortDecor.java $
 * $Author: sanderst $
 * $Revision: 1.2 $
 ...
 * underlying <code>ShortI</code>.
 */
public class ConstShortDecor extends AbstractValue
                            implements ShortI,
                                       Cloneable
{  
  private ShortI delegate_;
  
	public ConstShortDecor(ShortI d)
	{
    delegate_ = d;
	}
