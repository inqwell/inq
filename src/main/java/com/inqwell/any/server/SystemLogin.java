...
/*
 * $Archive: /src/com/inqwell/any/server/SystemLogin.java $
 * $Author: sanderst $
 * $Revision: 1.2 $
 ...
 */
public class SystemLogin extends Service
{
  
  private static StringI servicePath__ = new ConstString("system.services.Login");

  public SystemLogin() throws AnyException
  {
    init();
  }
  ...
  {
		// At the moment we don't do much but later we would
		// look up passwords in config files etc.
