...
/*
 * $Archive: /src/com/inqwell/any/PostDecrement.java $
 * $Author: sanderst $
 * $Revision: 1.2 $
 ...
 */
public final class PostDecrement extends MutatingOperator
{
  public Any doOperation (Any op1, Any op2) throws AnyException
  {
    ...
    // post-decrement must return a temporary, rather than
