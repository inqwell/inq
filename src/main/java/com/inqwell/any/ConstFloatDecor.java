...
/*
 * $Archive: /src/com/inqwell/any/ConstFloatDecor.java $
 * $Author: sanderst $
 * $Revision: 1.2 $
 ...
 * underlying <code>FloatI</code>.
 */
public class ConstFloatDecor extends AbstractValue
                            implements FloatI,
                                       Cloneable
{  
  private FloatI delegate_;
  
	public ConstFloatDecor(FloatI d)
	{
    delegate_ = d;
	}
