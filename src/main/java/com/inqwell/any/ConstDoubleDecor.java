...
/*
 * $Archive: /src/com/inqwell/any/ConstDoubleDecor.java $
 * $Author: sanderst $
 * $Revision: 1.2 $
 ...
 * underlying <code>DoubleI</code>.
 */
public class ConstDoubleDecor extends AbstractValue
                            implements DoubleI,
                                       Cloneable
{  
  private DoubleI delegate_;
  
	public ConstDoubleDecor(DoubleI d)
	{
    delegate_ = d;
	}
