...
/*
 * $Archive: /src/com/inqwell/any/PreIncrement.java $
 * $Author: sanderst $
 * $Revision: 1.2 $
 ...
 */
public final class PreIncrement extends MutatingOperator
{
  public Any doOperation (Any op1, Any op2) throws AnyException
  {
    ...
    // pre-increment can return the original operand, rather than
    // a temporary, since we want the result to be the incremented
    // value.
    return op1;
  }
  ...
  {
    // For dates this is defined as advancing one day (FWIW)
