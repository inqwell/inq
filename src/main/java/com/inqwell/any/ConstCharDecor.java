...
/*
 * $Archive: /src/com/inqwell/any/ConstCharDecor.java $
 * $Author: sanderst $
 * $Revision: 1.2 $
 ...
 * underlying <code>CharII</code>.
 */
public class ConstCharDecor extends AbstractValue
                            implements CharI,
                                       Cloneable
{  
  private CharI delegate_;
  
	public ConstCharDecor(CharI d)
	{
    delegate_ = d;
	}
