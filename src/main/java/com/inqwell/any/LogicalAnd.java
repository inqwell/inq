...
/*
 * $Archive: /src/com/inqwell/any/LogicalAnd.java $
 * $Author: sanderst $
 * $Revision: 1.3 $
 ...
 */
public class LogicalAnd extends OperatorVisitor
{
	/**
	 * Evaluate first operand and if false, don't evaluate
	 * second
	 */
  public Any doOperation (Any op1, Any op2) throws AnyException
  {
    ...
    if (!result.getValue())
      return result;   // op1 is false so don't evaluate op2
  ...
  {
    // Not called because we have overridden doOperation, above.
    if (res1 == null)
      notResolved(op1);
