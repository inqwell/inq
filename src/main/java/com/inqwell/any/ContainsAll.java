...
/*
 * $Archive: /src/com/inqwell/any/ContainsAll.java $
 * $Author: sanderst $
 * $Revision: 1.2 $
 ...
 */
public class ContainsAll extends    AbstractFunc
                         implements Cloneable
{
	...
	public ContainsAll(Any container, Any contains)
	{
    ...
    ret.setValue(container.containsAll(contains));
  ...
  {
		ContainsAll c = (ContainsAll)super.clone();
