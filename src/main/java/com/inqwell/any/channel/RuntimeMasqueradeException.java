...
/*
 * $Archive: /src/com/inqwell/any/channel/RuntimeMasqueradeException.java $
 * $Author: sanderst $
 * $Revision: 1.3 $
 ...
 */ 
public class RuntimeMasqueradeException extends AnyRuntimeException
{
	private String stackTrace_;
	
  public RuntimeMasqueradeException(Exception                e,
                                    Any                      userInfo,
                                    ...
                                    boolean                  isUser)
  {
	...
	public void printStackTrace() { System.out.println (stackTrace_); }
