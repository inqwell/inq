...
import com.inqwell.any.beans.AnyDocumentEvent;
...
//											new SpinEditListenerAdapter(ListenerConstants.SPINEDIT));
    ...
    ListenerAdapterFactory.addAdapter
                     (ListenerConstants.COMPONENT,
                      new ComponentListenerAdapter(ListenerConstants.COMPONENT));
	}
	...
	private static abstract class BaseListenerAdapter extends    AbstractAny
	 ...
	 */
	private static class ActionListenerAdapter extends    BaseListenerAdapter
	 ...
	 */
	private static class SelectionListenerAdapter extends    BaseListenerAdapter
	 ...
	 */
	private static class FocusListenerAdapter extends    BaseListenerAdapter
	 ...
	 */
	private static class MenuListenerAdapter extends    BaseListenerAdapter
	 ...
	 */
	private static class PopupMenuListenerAdapter extends    BaseListenerAdapter
	 ...
	 */
	private static abstract class BaseMouseAdapter extends BaseListenerAdapter
	{
	 ...
	 */
	private static class MouseListenerAdapter extends    BaseMouseAdapter
	...
	private static class MouseMotionListenerAdapter extends    BaseMouseAdapter
	 ...
	 * modifiers as a distinct event type, represented by a Map.
	 */
	private static class KeyListenerAdapter extends    BaseListenerAdapter
	...
	private static class WindowListenerAdapter extends    BaseListenerAdapter
	...
	private static class IWindowListenerAdapter extends    BaseListenerAdapter
	...
	private static class DocumentListenerAdapter extends    BaseListenerAdapter
	...
	private static class DialogListenerAdapter   extends    BaseListenerAdapter
	...
	private static class TableEditListenerAdapter   extends    BaseListenerAdapter
	...
	private static class ContextListenerAdapter   extends    BaseListenerAdapter
...
//}
	...
	private static class FileChooserListenerAdapter   extends    BaseListenerAdapter
	 ...
	 */
	private static class ItemListenerAdapter extends    BaseListenerAdapter
	 ...
	 */
	private static class ChangeListenerAdapter extends    BaseListenerAdapter
	...
	private static class TreeSelectionListenerAdapter extends    BaseListenerAdapter
	...
	private static class TreeExpansionListenerAdapter extends    BaseListenerAdapter
	...
	private static class TreeWillExpandListenerAdapter extends    BaseListenerAdapter
	...
	private static class ComponentListenerAdapter extends    BaseListenerAdapter
	                                              implements java.awt.event.ComponentListener
	{
	  ...
	  static
	  {
	    eventTypes_.add(EventConstants.E_HIDDEN);
	    eventTypes_.add(EventConstants.E_MOVED);
	    eventTypes_.add(EventConstants.E_RESIZED);
	    eventTypes_.add(EventConstants.E_SHOWN);
	  }
	  
	  public ComponentListenerAdapter(Any eventGategory)
	  {
	    super(eventGategory);
	  }
	  ...
	  {
	    AnyEvent anyEvt = new AnyEvent(e, EventConstants.E_HIDDEN);
	    notifyAdaptee(anyEvt);
	  }
	  ...
	  {
	    AnyEvent anyEvt = new AnyEvent(e, EventConstants.E_MOVED);
	    augmentEvent(e, anyEvt);
	    notifyAdaptee(anyEvt);
	  }
	  ...
	  {
	    AnyEvent anyEvt = new AnyEvent(e, EventConstants.E_RESIZED);
	    augmentEvent(e, anyEvt);
	    notifyAdaptee(anyEvt);
	  }
	  ...
	  {
	    AnyEvent anyEvt = new AnyEvent(e, EventConstants.E_SHOWN);
	    augmentEvent(e, anyEvt);
	    notifyAdaptee(anyEvt);
	  }
	  ...
	  private void augmentEvent(ComponentEvent e, AnyEvent ae)
	  {
	    Component c = e.getComponent();
	    Rectangle r = c.getBounds();
	    IntI x = new ConstInt(r.x);
	    IntI y = new ConstInt(r.y);
	    IntI w = new ConstInt(r.width);
	    IntI h = new ConstInt(r.height);
	    ae.add(AnyView.x__, x);
	    ae.add(AnyView.y__, y);
	    ae.add(AnyView.width__, w);
	    ae.add(AnyView.height__, h);
	  }
	}
}
