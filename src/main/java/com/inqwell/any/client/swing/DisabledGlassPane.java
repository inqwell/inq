 ...
 * <p/>
 * This code from Rob Camick's website at
 * http://tips4java.wordpress.com/2008/11/07/disabled-glass-pane/
 */
public class DisabledGlassPane extends    JComponent
                               implements KeyListener
{
  private final static Border MESSAGE_BORDER = new CompoundBorder(new LineBorder(Color.BLACK),
  ...
  public DisabledGlassPane()
  {
    ...
    if (base == null)
      base = UIManager.getColor("window"); // for GTK
    if (base == null)
