...
/*
 * $Archive: /src/com/inqwell/any/DeclareArray.java $
 * $Author: sanderst $
 * $Revision: 1.3 $
...
public class DeclareArray extends    Declare
                          implements Cloneable
{
  ...
  public DeclareArray(Locate at, Any var, Array compositeMembers)
  {
    super(at, var);
  ...
  public Any exec (Any a) throws AnyException
  {
    ...
    Array var = (Array)evaluateVar(a, t);
