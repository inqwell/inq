...
/*
 * $Archive: /src/com/inqwell/any/LessThanOrEquals.java $
 * $Author: sanderst $
 * $Revision: 1.3 $
...
/**
 * Compare two Anys and return true if op1 is less than or equal to op2;
 * false otherwise
 * @author $Author: sanderst $
 * @version $Revision: 1.3 $
 * @see com.inqwell.any.Any
 */
public class LessThanOrEquals extends OperatorVisitor
{
