...
/*
 * $Archive: /src/com/inqwell/any/ConstBooleanDecor.java $
 * $Author: sanderst $
 * $Revision: 1.2 $
 ...
 * underlying <code>BooleanI</code>.
 */
public class ConstBooleanDecor extends AbstractValue
                               implements BooleanI,
                                          Cloneable
{  
  private BooleanI delegate_;
  
	public ConstBooleanDecor(BooleanI d)
	{
    delegate_ = d;
	}
