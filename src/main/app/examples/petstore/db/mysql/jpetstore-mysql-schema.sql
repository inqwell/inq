...
drop database if exists ipetstore;
create database ipetstore;

-- create a dev user for ipetstore
grant all on ipetstore.* to 'pet1'@'%' identified by 'pet1';
grant all on ipetstore.* to 'pet1'@'localhost' identified by 'pet1';
grant all on ipetstore.* to 'pet1'@'localhost.localdomain' identified by 'pet1';
...
create table if not exists orders (
      ...
      status varchar(2) not null,          -- Added for inq
...
create table if not exists category (
	...
	name varchar(80) null,
	icon varchar(64) null,   -- Added for inq
...
create table if not exists item (
    ...
    lastprice decimal(10,2) null,          -- Added for inq
    lastpricemove varchar(2) null,         -- Added for inq
    supplier int null,
    status varchar(2) null,
