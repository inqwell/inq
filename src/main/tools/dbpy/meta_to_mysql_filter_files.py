#!/usr/local/bin/bash
"""
Convert a meta-filter file into a MySQL filter file.
"""

from meta_to_db_filter_files import MetaToDbFilter
from xml_to_mysql_utils import get_db_renamings
...
class MetaToMySqlFilter(MetaToDbFilter):
    """
    Class for converting a meta-filter file into a MySQL filter file.
    """
